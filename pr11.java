...
//THIS PROGRAM PREPARED BY Harshal 21CE052
...
public class pr11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("HARSHAL ", 19, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("ROHIT", 33, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("DHONI", 39, 'M');
